...
-- library init
	...
	writefile("ffff.ttf", game:HttpGet("https://github.com/afgan32/font/raw/refs/heads/main/fs-tahoma-8px.ttf"))
		...
		function library:esp_preview(properties)
			...
			local items = cfg.items; do 
				...
				library:connection(run.RenderStepped, function()
					task.wait()
					cfg.rotation += 0.5
					local char_y = flags["esp_character_y_offset"] or 1
					character:SetPrimaryPartCFrame(cfr(Vector3.new(0, char_y, -6)) * angle(0, math.rad(cfg.rotation), 0))
				end)
			end 
